      ...
      <div className="relative bg-slate-200 box-border caret-transparent gap-x-[15px] grid auto-cols-[1fr] grid-cols-[1fr] grid-rows-[auto] gap-y-[15px] p-[15px] rounded-[20px] md:gap-x-[100px] md:grid-cols-[1fr_0.75fr] md:gap-y-[100px] md:p-[70px]">
        ...
        <div className="items-start box-border caret-transparent gap-x-5 flex flex-col justify-between gap-y-5 text-left md:items-end md:text-right">
          <p className="box-border caret-transparent text-left mb-2.5 md:text-right">
            Tell us about your decking project and we will arrange a free quote.
          </p>
          <a
            href="/contact"
            className="text-white text-sm font-bold bg-[#c2410c] box-border caret-transparent block leading-[19.6px] text-center border border-[#c2410c] px-5 py-2 rounded-[50px] border-solid md:text-lg md:leading-[25.2px] md:px-[30px] md:py-3 hover:bg-[#ea580c] hover:decoration-transparent shadow-[0_0_20px_rgba(234,88,12,0.45),0_0_40px_rgba(234,88,12,0.25)] hover:shadow-[0_0_30px_rgba(234,88,12,0.6),0_0_60px_rgba(234,88,12,0.45)] transition-shadow duration-300"
          >
